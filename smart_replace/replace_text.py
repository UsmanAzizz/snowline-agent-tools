...
def main():
    ...
    if not args.apply:
        ...
        if risk_label.startswith("Low"):
            ...
            print(f'"Berdasarkan hasil dry-run di atas (Risk: {risk_label}), Anda WAJIB memvalidasi syntax atau menjalankan linter terlebih dahulu sebelum melakukan --apply. Jika terbukti aman, baru terapkan perubahannya."')
    else:
