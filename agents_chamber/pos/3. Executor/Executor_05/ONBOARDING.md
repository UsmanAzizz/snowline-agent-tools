...
## COORDINATION FLOW
```
1. TL -> 3. Executor/Executor_05    (assigns implementation task)
3. Executor/Executor_05 -> 1. TL    (reports proposal, then results + evidence)
```
...
4. Read `pos/3. Executor/Executor_05/connector.md` (your own file) for your actual current task.
