...
## COORDINATION FLOW
```
1. TL -> 3. Executor/Executor_04    (assigns implementation task)
3. Executor/Executor_04 -> 1. TL    (reports proposal, then results + evidence)
```
...
4. Read `pos/3. Executor/Executor_04/connector.md` (your own file) for your actual current task.
