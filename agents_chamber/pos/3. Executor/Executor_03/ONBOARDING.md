...
## COORDINATION FLOW
```
1. TL -> 3. Executor/Executor_03    (assigns implementation task)
3. Executor/Executor_03 -> 1. TL    (reports proposal, then results + evidence)
```
...
4. Read `pos/3. Executor/Executor_03/connector.md` (your own file) for your actual current task.
